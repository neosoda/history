...
const MIGRATION_STORAGE_KEY = 'history-migration-banner-dismissed';
const DISCORD_STORAGE_KEY = 'history-discord-banner-dismissed';
        ...
        <div className="bg-muted/80 backdrop-blur-sm border-b border-border/50">
          <div className="max-w-4xl mx-auto px-4 py-2 flex items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              History utilise désormais la <span className="font-medium text-foreground">connexion avec Valyu</span>.
              Si vous aviez un compte, connectez-vous avec Valyu pour retrouver votre historique.
            </p>
            <button
